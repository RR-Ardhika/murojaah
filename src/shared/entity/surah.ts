...
export const surah: SurahType[] = [
  ...
  { id: 3, name: '3 Ali Imran', juz: [3, 4], totalLines: 334, totalAyah: 200 },
  { id: 4, name: '4 An-Nisa', juz: [4, 5, 6], totalLines: 294, totalAyah: 176 },
  { id: 5, name: '5 Al-Maidah', juz: [6, 7], totalLines: 240, totalAyah: 120 },
  { id: 6, name: "6 Al-An'am", juz: [7, 8], totalLines: 244, totalAyah: 165 },
  { id: 7, name: "7 Al-A'raf", juz: [8, 9], totalLines: 332, totalAyah: 206 },
  { id: 8, name: '8 Al-Anfal', juz: [9, 10], totalLines: 120, totalAyah: 75 },
  { id: 9, name: '9 At-Taubah', juz: [10, 11], totalLines: 206, totalAyah: 129 },
  { id: 10, name: '10 Yunus', juz: [11], totalLines: 174, totalAyah: 109 },
  { id: 11, name: '11 Hud', juz: [11, 12], totalLines: 195, totalAyah: 123 },
  { id: 12, name: '12 Yusuf', juz: [12, 13], totalLines: 177, totalAyah: 111 },
  { id: 13, name: "13 Ar-Ra'd", juz: [13], totalLines: 72, totalAyah: 43 },
  { id: 14, name: '14 Ibrahim', juz: [13], totalLines: 78, totalAyah: 52 },
  { id: 15, name: '15 Al-Hijr', juz: [14], totalLines: 62, totalAyah: 99 },
  { id: 16, name: '16 An-Nahl', juz: [14], totalLines: 206, totalAyah: 128 },
  { id: 17, name: '17 Al-Isra', juz: [15], totalLines: 175, totalAyah: 111 },
  { id: 18, name: '18 Al-Kahf', juz: [15, 16], totalLines: 178, totalAyah: 110 },
  { id: 19, name: '19 Maryam', juz: [16], totalLines: 118, totalAyah: 98 },
  { id: 20, name: '20 Taha', juz: [16], totalLines: 190, totalAyah: 135 },
  { id: 21, name: '21 Al-Anbiya', juz: [17], totalLines: 175, totalAyah: 112 },
  { id: 22, name: '22 Al-Hajj', juz: [17], totalLines: 118, totalAyah: 78 },
  { id: 23, name: "23 Al-Mu'minun", juz: [18], totalLines: 184, totalAyah: 118 },
  { id: 24, name: '24 An-Nur', juz: [18], totalLines: 102, totalAyah: 64 },
  { id: 25, name: '25 Al-Furqan', juz: [18, 19], totalLines: 114, totalAyah: 77 },
  { id: 26, name: "26 Asy-Syu'ara", juz: [19], totalLines: 160, totalAyah: 227 },
  { id: 27, name: '27 An-Naml', juz: [19, 20], totalLines: 116, totalAyah: 93 },
  { id: 28, name: '28 Al-Qasas', juz: [20], totalLines: 136, totalAyah: 88 },
  { id: 29, name: '29 Al-Ankabut', juz: [20, 21], totalLines: 106, totalAyah: 69 },
  { id: 30, name: '30 Ar-Rum', juz: [21], totalLines: 80, totalAyah: 60 },
  { id: 31, name: '31 Luqman', juz: [21], totalLines: 50, totalAyah: 34 },
  { id: 32, name: '32 As-Sajdah', juz: [21], totalLines: 44, totalAyah: 30 },
  { id: 33, name: '33 Al-Ahzab', juz: [21, 22], totalLines: 114, totalAyah: 73 },
  { id: 34, name: "34 Saba'", juz: [22], totalLines: 86, totalAyah: 54 },
  { id: 35, name: '35 Fatir', juz: [22], totalLines: 72, totalAyah: 45 },
  { id: 36, name: '36 Ya-Sin', juz: [22, 23], totalLines: 72, totalAyah: 83 },
  { id: 37, name: '37 As-Saffat', juz: [23], totalLines: 116, totalAyah: 182 },
  { id: 38, name: '38 Sad', juz: [23], totalLines: 69, totalAyah: 88 },
  { id: 39, name: '39 Az-Zumar', juz: [23, 24], totalLines: 114, totalAyah: 75 },
  { id: 40, name: '40 Gafir', juz: [24], totalLines: 128, totalAyah: 85 },
  { id: 41, name: '41 Fussilat', juz: [24, 25], totalLines: 82, totalAyah: 54 },
  { id: 42, name: '42 Asy-Syura', juz: [25], totalLines: 80, totalAyah: 53 },
  { id: 43, name: '43 Az-Zukhruf', juz: [25], totalLines: 100, totalAyah: 89 },
  { id: 44, name: '44 Ad-Dukhan', juz: [25], totalLines: 38, totalAyah: 59 },
  { id: 45, name: '45 Al-Jasiyah', juz: [25], totalLines: 54, totalAyah: 37 },
