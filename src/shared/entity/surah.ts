...
export const surah: SurahType[] = [
  ...
  { id: 46, name: '46 Al-Ahqaf', juz: [26], totalLines: 68, totalAyah: 35 },
  { id: 47, name: '47 Muhammad', juz: [26], totalLines: 61, totalAyah: 38 },
  { id: 48, name: '48 Al-Fath', juz: [26], totalLines: 66, totalAyah: 29 },
  { id: 49, name: '49 Al-Hujurat', juz: [26], totalLines: 39, totalAyah: 18 },
  { id: 50, name: '50 Qaf', juz: [26], totalLines: 41, totalAyah: 45 },
  {
    id: 51,
  ...
  { id: 61, name: '61 As-Saff', juz: [28], totalLines: 24, totalAyah: 14 },
